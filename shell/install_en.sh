...
acmeInstallSSL() {
	if [[ "${dnsSSLStatus}" == "true" ]]; then
		...
		if [[ -n "${txtValue}" ]]; then
			...
			echoContent yellow " ---> Please refer to this tutorial for adding methods, https://github.com/n1un1u/n2ray-agent/blob/master/documents/dns_txt.md"
...
dokodemoDoorUnblockStreamingMedia() {
	...
	echoContent red "\n=============================================================="
	echoContent yellow "# Notes"
	echoContent yellow "Any door unlock details, please check this article [https://github.com/n1un1u/n2ray-agent/blob/master/documents/netflix/dokodemo-unblock_netflix.md]\n"
